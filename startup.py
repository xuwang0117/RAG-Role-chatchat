...
from server.monkey_patch.fastchat_inference_patch import inferenc_patch
from server.monkey_patch.fastchat_worker_patch import fastchat_load_model_patch
inferenc_patch()
fastchat_load_model_patch()
...
def create_model_worker_app(log_level: str = "INFO", **kwargs) -> FastAPI:
    ...
    # 本地模型
        ...
        if kwargs["model_names"][0] in VLLM_MODEL_DICT and args.infer_turbo == "vllm":
            ...
            # parser_vllm = argparse.ArgumentParser()
            # parser_vllm = AsyncEngineArgs.add_cli_args(parser_vllm)
            # vllm_args, _ = parser_vllm.parse_known_args()
            # vllm_args.__dict__.update(args.__dict__)
